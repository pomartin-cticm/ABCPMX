...
Module Mod_ComDll
    ...
    '================================================================================================
    Sub ResolVP(ByRef RA() As Double, ByRef RB() As Double, ByRef IDIM As Short, ByRef tolerance As Double,
                ByRef NoVectP As Boolean, ByRef Txt_Recepteur As Object, ByRef Txt_Progress As Object,
                ByRef VP() As Double, ByRef VectP(,) As Double, ByRef NBVP As Integer, ByRef DUMP As Integer, ByRef CodeERR As Short)
        ...
        For I = 1 To N
            For J = 1 To I
                Reso_A(I, J) = RA(IndL(I, J))
                Reso_B(I, J) = RB(IndL(I, J))
            Next J
        Next I
        ...
        Dim WORK(LWORK + 7) As Double
        Dim IWORK(5 * N + 4) As Integer
        N = N + 1
        IL = IL + 1
        IU = IU + 1
        LWORK = LWORK + 8
...
suite1:
        ...
        Select Case IntPtr.Size
            ...
            Case 8 ' --> 64 bits
                ...
                '================================================================================================
                Call RESONVP_64(JOBVP, IRANGE, N, Reso_B, Reso_A, 0, 0, IL, IU, tolerance, M, ALPHAR, Reso_VP,
            ...
            Case Else '4 --> 32 bits 
                ...
                '================================================================================================
                Call RESONVP_32(JOBVP, IRANGE, N, Reso_B, Reso_A, 0, 0, IL, IU, tolerance, M, ALPHAR, Reso_VP,
