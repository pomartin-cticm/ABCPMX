...
#Region "===FERMETURE==="
    ...
    Private Sub TransfertSaisie(ByRef lModif As Boolean)
        ...
        GereTransfertValeur(GammaLoc.GammaM_fi_a, LogicielOptions.Gamma.GammaM_fi_a, lModif)
        GereTransfertValeur(GammaLoc.GammaM_fi_s, LogicielOptions.Gamma.GammaM_fi_s, lModif)
