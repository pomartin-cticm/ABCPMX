...
#Region "***Edition des paramètres***"
    ...
    Private Sub EditionParametresDalle(ByVal MyBeam As cls_Poutre)
        ...
        If lMixte Then AddLigneNDC(TABW2 & BlocG("NOTIONALSIZE") & TABAFF & "h\-0\=" & TABEGAL & GetStringInUnit(MyBeam.Dalle.NotionalSizeH0(MyBeam.Section.ProfilA), Enu_TypeVariable.Dimension, 4, 0, True))
