...
<System.Runtime.InteropServices.ProgId("CTICM_Modal2D_NET.Modal2D")> Public Class Modal2D
    'Public Class Modal2D

    <Serializable()> Public Structure MATERIAU
        Dim E As Double             'module d'élasticité        
    End Structure

    <Serializable()> Public Structure STR_NOEUDS
    ...
    <Serializable()> Public Structure STR_BARRES
    ...
    <Serializable()> Public Structure MAS_BARRES    'DANS LEUR REPERE LOCAL
    ...
    <Serializable()> Public Structure MOD_RESOLUTION
    ...
    <Serializable()> Public Structure MOD_RESULTATS
    ...
    'Module DLL d'analyse élastique de structures 2D (par Y. Galéa - CTICM - 2010)
    '-------------------------------------------------------------------------------
    Public Function Exec(ByRef MAT As MATERIAU, ByRef NOEUDS As STR_NOEUDS, ByRef BARRES As STR_BARRES, ByRef MASSES As MAS_BARRES, _
                         ByVal RESOLUTION As MOD_RESOLUTION, ByRef RESULTATS As MOD_RESULTATS) As Integer

        Call ANALYSE(MAT, NOEUDS, BARRES, MASSES, RESOLUTION, RESULTATS)
