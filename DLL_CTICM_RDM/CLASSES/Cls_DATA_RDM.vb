...
#Region " Attributs "
    ...
    Public Structure Struc_Output
        Dim VZ(,) As Double                    'Effort tranchant dans l’élément i, aux deux extrémités (0 à NbNodes-2, 0 à 1)
        Dim MYY(,) As Double                   'Moment fléchissant dans l’élément i, aux deux extrémités (0 à NbNodes-2, 0 à 1)

        Dim UZ() As Double                     'Déplacement vertical du nœud i (0 à NbNodes-1)
        Dim ROTY() As Double                   'Rotation du nœud i (0 à NbNodes-1)

        Dim RZ() As Double                     'Réactions verticales aux nœuds support (0 à NbAppuis-1)
    End Structure
