...
#Region " Vérifications de la résistance au déversement "
    ...
    Private Sub RunCritereDeversement(myPoutre As cls_Poutre, iCombi As Integer, MEd(,) As Decimal, lSigma As Boolean,
        ...
        CalculAlphaCritiqueN(myPoutre, iCombi, MEd, lConstructionPhase, AlphaCr, lOK)
    ...
    Private Sub CalculAlphaCritiqueN(myPoutre As cls_Poutre, iCombi As Integer, MEd(,) As Decimal, lConstructionPhase As Boolean,
        ...
        If lConstructionPhase Then
            CoefCombi = myPoutre.CombiA_ELCU.CoefCombi(iCombi)
        Else
            CoefCombi = myPoutre.CombiA_ELU.CoefCombi(iCombi)
        End If

        myAlphaCr.CalculAlphaCritique(myPoutre, CoefCombi, MEd, lConstructionPhase, AlphaCr, lOK)
