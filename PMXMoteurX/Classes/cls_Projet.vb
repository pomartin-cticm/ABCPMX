...
#Region " Fonctions support pour écriture du fichier de sauvegarde projet "
    ...
    Private Sub SaveFileBlocMaintienBac(MaintienBac As cls_MaintienBac, ByRef Lines As List(Of String))
        ...
        With MaintienBac
            ...
            AjouteLigneFrmt(Lines, "DiaFix", .dFpNerv)
    ...
    Private Sub SaveFileBlocOptionsFeu(myParamF As cls_OptionsFeu, ByRef Lines As List(Of String))
        ...
        With myParamF
            ...
            AjouteLigneFrmt(Lines, "CEpsilon", .EmissivityC)
            ...
            If nbMots > 0 Then
                ...
                With myBac
                    Select Case MotCle
                        ...
                        Case "FUP" : .Fup = CDec(TraiteReal(Mots(nbMots)))
            ...
            If nbMots > 0 Then
                ...
                With myParamF
                    Select Case MotCle
                        ...
                        Case "CEPSIL" : .EmissivityC = CDec(TraiteReal(Mots(nbMots)))
