            ...
            With ptre
                ...
                With .Param
                    ...
                    With .Gamma
                        ...
                        Lines.Add("   GammaM_fi_a     = " & .GammaM_fi_a)
                        Lines.Add("   GammaC_fi     = " & .GammaC_fi)
                        Lines.Add("   GammaM_fi_s   = " & .GammaM_fi_s)
            ...
            If nbMots > 0 Then
                ...
                With gamma_opt_calculs
                    Select Case MotCle
                        ...
                        Case "GAMMAM_FI_A" : .GammaM_fi_a = TraiteReal(Mots(nbMots))
                        Case "GAMMAC_FI" : .GammaC_fi = TraiteReal(Mots(nbMots))
                        Case "GAMMAM_FI_S" : .GammaM_fi_s = TraiteReal(Mots(nbMots))
